...
func TestErrorBoundaryEventDefinition(t *testing.T) {
	...
	assert.Equal("testError", boundaryEvent.EventDefinition.Error.Id)
	assert.Equal("testErrorName", boundaryEvent.EventDefinition.Error.Name)
	assert.Equal("testErrorCode", boundaryEvent.EventDefinition.Error.Code)
}
