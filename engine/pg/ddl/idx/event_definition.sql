...
CREATE UNIQUE INDEX IF NOT EXISTS event_definition_message_name_idx ON event_definition (message_name) WHERE message_name IS NOT NULL AND is_suspended IS FALSE;
